      ...
      <div className="h-screen overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto mb-5.5 mt-4.5 grid max-w-lg grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                An experienced full stack developer adept in all stages of
                advanced web development and also mobile app development seeking
                a challenging role in technology with a company that offers
                opportunities for growth and is open to relocation.
              </p>
            </div>
            ...
            <div className="mt-6.5">
              ...
              <div className="flex items-center justify-center gap-3.5">
                <a
                  href="https://www.linkedin.com/in/josh-chuang-50a05b251/"
                  target="_blank"
